...
export default function Conversation() {
  ...
  return (
    <div>
      <div className='mb-6'>
        <div
          className={`card mb-4 flex flex-col border border-primary p-4 ${select === 1 ? 'bg-primary text-[#ffffff]' : ''} cursor-pointer duration-200`}
          onClick={() => {
            setSelect(1)
        ...
        <div
          className={`card mb-4 flex flex-col border border-primary p-4 ${select === 2 ? 'bg-primary text-[#ffffff]' : ''} cursor-pointer duration-200`}
          onClick={() => {
            setSelect(2)
